...
- Modo histórico: España 1936, con el reparto real de provincias tras el golpe, dos bandos de dos facciones y una crónica de guerra que cambia según quién ataque y desde dónde
...
- Historical mode: Spain 1936, with the real provincial split after the coup, two sides of two factions each, and a war chronicle that changes with who attacks and from where
