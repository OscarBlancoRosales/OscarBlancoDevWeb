...
const TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  'admin.tab.accesos': { es: 'Accesos', en: 'Access' },

  'acc.cargando': { es: 'Mirando quién está dentro…', en: 'Checking who is in…' },
  'acc.kpiAparatos': { es: 'Aparatos dentro', en: 'Devices in' },
  'acc.kpiPersonas': { es: 'Personas', en: 'People' },
  'acc.kpiSitios': { es: 'Direcciones', en: 'Addresses' },
  'acc.kpiTotal': { es: 'Accesos guardados', en: 'Recorded sessions' },
  'acc.buscar': { es: 'Buscar por correo, aparato o IP', en: 'Search by email, device or IP' },
  'acc.soloDentro': { es: 'Solo los que están dentro', en: 'Only the ones still in' },
  'acc.refrescar': { es: 'Actualizar', en: 'Refresh' },
  'acc.aparato': { es: 'Aparato', en: 'Device' },
  'acc.ip': { es: 'Desde', en: 'From' },
  'acc.empezo': { es: 'Entró', en: 'Signed in' },
  'acc.ultimo': { es: 'Última vez', en: 'Last seen' },
  'acc.refrescos': { es: 'Renovaciones', en: 'Renewals' },
  'acc.dentro': { es: 'Dentro', en: 'In' },
  'acc.cerrada': { es: 'Cerrada', en: 'Closed' },
  'acc.caducada': { es: 'Caducada', en: 'Expired' },
  'acc.echado': { es: 'Echado', en: 'Kicked' },
  'acc.cerrar': { es: 'Cerrar', en: 'Close' },
  'acc.relogin': { es: 'Forzar relogin', en: 'Force re-login' },
  'acc.ninguno': { es: 'No hay ningún acceso.', en: 'No sessions recorded.' },
  'acc.sinAgente': { es: 'No dijo qué era.', en: 'It did not say what it was.' },
  'acc.caducaEl': { es: 'Caduca el {cuando}.', en: 'Expires on {cuando}.' },
  'acc.pie': {
    es: 'Cerrar echa a ese aparato. Forzar relogin se lleva todos los de esa persona y también su acceso ya firmado, así que cae fuera en su siguiente petición, no cuando caduque.',
    en: 'Closing kicks that one device. Forcing re-login takes every device of that person plus their already-signed access, so they drop out on their next request, not when it expires.',
  },
  ...
  'salas.bloqueQue': {
    es: 'Cierra de golpe todas las que está enseñando la tabla, sin la búsqueda por texto. Afina con los filtros de arriba.',
    en: 'Closes at once every room the table is showing, minus the text search. Narrow it with the filters above.',
  },
  'salas.bloqueCerrar': { es: 'Cerrar {cuantas} salas', en: 'Close {cuantas} rooms' },
  'salas.bloqueCerrarUna': { es: 'Cerrar una sala', en: 'Close one room' },
  'salas.bloqueSeguro': { es: '¿Seguro? Se cerrarán {cuantas}', en: 'Sure? {cuantas} will close' },
  'salas.bloqueSeguroUna': { es: '¿Seguro? Se cerrará una', en: 'Sure? One will close' },
  'salas.bloqueNinguna': { es: 'No encaja ninguna', en: 'Nothing matches' },
