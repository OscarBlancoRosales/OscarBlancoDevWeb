...
const PERSONA: Seat = { id: 'persona', displayName: 'Óscar', isBot: false, connected: true };
const MAQUINA: Seat = { id: 'maquina', displayName: 'Bot', isBot: true, connected: false };
...
describe('moverBots', () => {
  ...
  it('mueve a varios bots en la misma pasada', () => {
    const dosBots = mesa([
      PERSONA,
      { id: 'uno', displayName: 'Uno', isBot: true, connected: false },
      { id: 'otro', displayName: 'Otro', isBot: true, connected: false },
    ]);
